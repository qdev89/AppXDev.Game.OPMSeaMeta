export const defaultTeamGuides = [
  {
    ...
    formation: {
      frontRow: ["ssr_silverfang", "ssr_superalloy", "ssr_garou"],
      backRow: ["ur_saitama", "ur_tatsumaki", "ssr_atomic"]
    },
    speedOrder: [
      { order: 1, hero: "ur_saitama", note: "Turn-1 column nuke & buff dispel" },
      { order: 2, hero: "ssr_atomic", note: "AoE Shatter debuff on enemy team" },
      ...
      { order: 5, hero: "ssr_silverfang", note: "Team Tenacity barrier & core energy" },
  ...
  },
  {
    ...
    formation: {
      ...
      backRow: ["ur_gyoro", "urplus_zombieman", "ssr_boros"]
    },
    speedOrder: [
      ...
      { order: 4, hero: "ssr_boros", note: "Targeted single-burst finisher" },
  ...
  },
  {
    ...
    formation: {
      ...
      backRow: ["sr_goldenball", "sr_amaimask", "ssr_atomic"]
    },
    speedOrder: [
      { order: 1, hero: "sr_goldenball", note: "Applies 100% AoE Shatter" },
      { order: 2, hero: "ssr_atomic", note: "Exploits Shatter for bonus AoE damage" },
      { order: 3, hero: "sr_amaimask", note: "Snipes backrow enemy carry" },
